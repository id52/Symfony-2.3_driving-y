...
var ru = {
		...
		fakeObject : 'Видео',
		properties : 'Редактировать',
		widthRequired : 'Ширина не может быть пустой',
		heightRequired : 'Высота не может быть пустой',
		poster: 'Картинка к видео',
		sourceVideo: 'Источник видео',
		sourceType : 'Тип файла',
		linkTemplate :  '<a href="%src%">%type%</a> ',
		fallbackTemplate : 'Ваш браузер не поддерживает HTML5-видео.<br>Пожалуйста, скачайте файл: %links%'
	};
